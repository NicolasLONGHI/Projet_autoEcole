            ...
            if (leUser == null){
                ...
                if (leUser == null) {
                    ...
                    if (leUser == null) {
                        ...
                        JOptionPane.showMessageDialog(this, "L'accès à l'espace responsable sera disponible dans la version 2.0", "Accès indisponible", JOptionPane.WARNING_MESSAGE);
